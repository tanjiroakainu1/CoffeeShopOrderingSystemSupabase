...
export const CafeLocation = {
  ...
  shortLabel: "Quezon City, Metro Manila",
  regionEyebrow: "Quezon City café",
  visitUsLine: "Maginhawa St, Teachers Village · Quezon City, Metro Manila",
  latitude: 14.6417,
  longitude: 121.0509,
  googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=14.6417,121.0509",
} as const;
